...
SECRET_KEY = 'p-zy$!-^cc3o&7#stda&%g^e7wo8nz!s!4z7dan6ggiqm=*re='
...
# Keep default Django User model for authentication
# Custom AttendanceUser model will store additional data in Attendancetracker.users
